...
// The reviewed package is generated by `npm run review:apply` from the base
// conversion output plus the tracked repairs and review decisions; the base
// review-required file is never promoted directly.
const input = resolve(valueFor("--input") ?? "converted/enraged-eggplant/doa-monsters.reviewed.json");
...
const published = {
  manifest: {
    ...
    credits: publicCredits(candidate.manifest.credits),
